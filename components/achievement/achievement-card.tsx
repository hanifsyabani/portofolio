...
export default function AchievementCard({
  ...
  return (
    <Card className="group cursor-pointer relative h-full overflow-hidden bg-linear-to-br from-neutral-900/40 to-neutral-950/60 p-4 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/15 border border-neutral-800/50 hover:border-emerald-500/30">
      ...
      <div className="relative z-10 flex flex-col gap-4 h-full">
        {/* Image Container */}
        <div className="relative h-32 w-full overflow-hidden rounded-lg bg-neutral-800/50">
          <Image
            src={image}
            alt={name}
            fill
